...
\begin{definition}{Unit Vector}{unit_vector}
A vector $\vv{v}$ is called a \textbf{unit vector} if its magnitude is 1, i.e., $\norm{\vv{v}} = 1$.

In general, a unit vector of any function is given by:
\[
\hat{v} = \frac{\vv{v}}{\norm{\vv{v}}}
\]
\end{definition}
...
Equivalently, we have a geometric definition.
\begin{definition}{Parallel Vectors (Geometric)}{parallel_vectors_geom}
